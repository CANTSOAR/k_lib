...
\begin{document}
    ...
    % Input layer
		\node[unit, label=left:{$\sigma\left({T}_1,{K}_1\right)$}](x0) at (0,3.5){};
		\node[unit, label=left:{$\sigma\left({T}_2,{K}_2\right)$}](x1) at (0,2){};
		\node at (0,1){\vdots}; 
		\node[unit, label=left:{$\sigma\left({T}_N,{K}_N\right)$}](xd) at (0,0){};
    ...
    % Output layer
		\node[unit, label=right:$z_1$](y1) at (12,3.5){};
		\node[unit, label=right:$z_2$](y2) at (12,2){};
		\node at (12,1){\vdots};
		\node[unit, label=right:$z_d$](yc) at (12,0){};
